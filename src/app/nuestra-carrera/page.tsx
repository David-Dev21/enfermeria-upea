                    ...
                    <FlipCard
                        ...
                        backContent={
                            <div className="text-sm cursor-pointer">
                                <p>La profesional de Enfermería, se caracteriza por:</p><ul><li>Poseer una formación científica – técnica - ética y humana, fortaleciendo constantemente su preparación, logrando la excelencia en su desempeño profesional, trabajando en forma independiente, multidisciplinaria y multisectorial, en las áreas: urbanas, suburbanas y rural.</li><li>Demostrar vocación y compromiso moral, ético y social de acuerdo a nuestro contexto real, como es la identidad propia, valorizando y conociendo nuestra cultura andina.</li><li>Asumir la enfermería con capacidad crítica y reflexiva para prestar atención integral al usuario hospitalizado y/o en comunidad, identificando sus necesidades y aplicando los principios científicos, con atención humanizada dentro el marco ético legal.</li><li>Tener capacidad de intervención y toma de decisiones en la solución de problemas de salud de las personas, las familias y los grupos comunitarios de la ciudad de El Alto, las provincias y el país, asumiendo el rol de educador en salud.</li><li>Utilizar la investigación para la resolución de problemas de salud y de la propia enfermería, generando cambios en los diferentes niveles de atención del sistema de salud, en las áreas: urbanas, sub. urbanas y rural de la ciudad de El Alto y el país.</li></ul>
                            </div>
                        }
                    />
