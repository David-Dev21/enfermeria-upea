            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <motion.div
                    ...
                    <Card className="w-2/3 mx-auto mt-4">
                        <CardContent >
                            <h2 className="text-center text-2xl text-primary font-semibold mb-2">
                                <FontAwesomeIcon icon={faAddressBook} /> Contactos</h2>
                            <div className="text-center text-lg text-gray-600 ">
                                <p><FontAwesomeIcon icon={faPhone} /> 77775964 - <FontAwesomeIcon icon={faPhone} /> 70592234</p>
                                <p></p>
                                <p><FontAwesomeIcon icon={faEnvelope} /> enfermeria-upea@gmail.com</p>
                            </div>
                        </CardContent>
                    </Card>
                    <motion.div className="w-2/3 mx-auto flex justify-around mt-4 text-3xl" initial={{ y: -20 }} animate={{ y: 0 }} transition={{ type: "spring", stiffness: 100 }}>
