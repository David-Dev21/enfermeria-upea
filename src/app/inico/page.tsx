...
const Welcome = () => {
    ...
    return (
        <>
            ...
            <section className="max-w-screen-xl mt-14 md:mt-36 mx-auto px-4 md:px-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <motion.div
                        className="w-56 h-56 place-self-center md:w-full md:h-96 object-cover shadow-md rounded-3xl"
                        key={currentImage}
                        variants={variants}
                        initial="enter"
                        animate="center"
