    ...
    return (
        <footer className="bg-tertiary mt-10 ">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="grid grid-cols-1 pt-4 md:grid-cols-3 gap-8">
                    <div className='flex flex-col my-4 text-center justify-center'>
                        <a href="#" className='flex justify-center'>
                            <Image src="/images/logo-enfermeria.png" alt="enfermeria" width={80} height={80} />
                        </a>
                    ...
                    <div className='flex flex-col my-4 text-center justify-center'>
                        <a href="https://utic.upea.bo/" className='flex justify-center' target='_blank'>
                            <Image src="/images/utic-logo.jpg" alt="enfermeria" width={80} height={80} className='rounded-full' />
                        </a>
                ...
                <p className="text-gray-600 text-center mt-2">©U-TIC 2025 | Desarrollado por
